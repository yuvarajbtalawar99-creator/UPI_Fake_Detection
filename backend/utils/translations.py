# -*- coding: utf-8 -*-
"""
Multi-language translation support for KAVACH.
...
TRANSLATIONS = {
    "en": {
        ...
        "date": "Date",
        "merchant": "Merchant",
        "qr_decoded": "QR Decoded Data",
        "url_analysis": "URL Analysis",
        "no_ocr": "OCR engine not available. Install Tesseract or EasyOCR.",
        "no_qr": "Could not decode QR code from image.",
        "invalid_url": "Please enter a valid URL.",
        "language": "Language",
        "safe_qr": "Safe QR Code",
        "blocked_qr": "Blocked – Suspicious QR Code",
        "safe_url": "Safe Website",
        "blocked_url": "Blocked – Phishing Website",
        "screenshot_blocked": "Blocked – Fake Payment Screenshot",
    ...
    "hi": {
        ...
        "suspicious_msg": "कुछ असामान्यताएं पाई गईं। कृपया मैन्युअल रूप से सत्यापित करें।",
        ...
        "date": "तारीख",
        "merchant": "व्यापारी",
        "qr_decoded": "QR डिकोड डेटा",
        "url_analysis": "URL विश्लेषण",
        "no_ocr": "OCR इंजन उपलब्ध नहीं है।",
        "no_qr": "QR कोड डिकोड नहीं हो सका।",
        "invalid_url": "कृपया एक मान्य URL दर्ज करें।",
        "language": "भाषा",
        "safe_qr": "सुरक्षित QR कोड",
        "blocked_qr": "अवरुद्ध – संदिग्ध QR कोड",
        "safe_url": "सुरक्षित वेबसाइट",
        "blocked_url": "अवरुद्ध – फिशिंग वेबसाइट",
        "screenshot_blocked": "अवरुद्ध – नकली भुगतान स्क्रीनशॉट",
    ...
    "kn": {
        ...
        "date": "ದಿನಾಂಕ",
        "merchant": "ವ್ಯಾಪಾರಿ",
        "qr_decoded": "QR ಡಿಕೋಡ್ ಡೇಟಾ",
        "url_analysis": "URL ವಿಶ್ಲೇಷಣೆ",
        "no_ocr": "OCR ಎಂಜಿನ್ ಲಭ್ಯವಿಲ್ಲ.",
        "no_qr": "QR ಕೋಡ್ ಡಿಕೋಡ್ ಮಾಡಲಾಗಲಿಲ್ಲ.",
        "invalid_url": "ದಯವಿಟ್ಟು ಮಾನ್ಯ URL ನಮೂದಿಸಿ.",
        "language": "ಭಾಷೆ",
        "safe_qr": "ಸುರಕ್ಷಿತ QR ಕೋಡ್",
        "blocked_qr": "ನಿರ್ಬಂಧಿಸಲಾಗಿದೆ – ಅನುಮಾನಾಸ್ಪದ QR ಕೋಡ್",
        "safe_url": "ಸುರಕ್ಷಿತ ವೆಬ್‌ಸೈಟ್",
        "blocked_url": "ನಿರ್ಬಂಧಿಸಲಾಗಿದೆ – ಫಿಶಿಂಗ್ ವೆಬ್‌ಸೈಟ್",
        "screenshot_blocked": "ನಿರ್ಬಂಧಿಸಲಾಗಿದೆ – ನಕಲಿ ಪಾವತಿ ಸ್ಕ್ರೀನ್‌ಶಾಟ್",
        ...
        "url_card_desc": "ನೀವು ಕ್ಲಿಕ್ ಮಾಡುವ ಮೊದಲು ಲಿಂಕ್ ಅಸಲಿ ಅಥವಾ ನಕಲಿ ಲಾಟರಿ ಹಗರಣವೇ ಎಂದು ಪರಿಶೀಲಿಸಿ.",
    ...
    "mr": {
        ...
        "qr_decoded": "QR डिकोड डेटा",
        "url_analysis": "URL विश्लेषण",
        "no_ocr": "OCR इंजिन उपलब्ध नाही.",
        "no_qr": "QR कोड डिकोड करता आला नाही.",
        "invalid_url": "कृपया वैध URL प्रविष्ट करा.",
        "language": "भाषा",
        "safe_qr": "सुरक्षित QR कोड",
        "blocked_qr": "अवरोधित – संशयास्पद QR कोड",
        "safe_url": "सुरक्षित वेबसाइट",
        "blocked_url": "अवरोधित – फिशिंग वेबसाइट",
        "screenshot_blocked": "अवरोधित – बनावट पेमेंट स्क्रीनशॉट",
        ...
        "yesterday": "काल",
        "cyber_safety_tips": "सायबर सुरक्षा टिप्स",
